...
exports.EnvironmentInSerializer = {
    _fromJsonObject(object) {
        return {
            connectors: object["connectors"].map((item) => connectorIn_1.ConnectorInSerializer._fromJsonObject(item)),
            eventTypes: object["eventTypes"].map((item) => eventTypeIn_1.EventTypeInSerializer._fromJsonObject(item)),
