...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"1.25.2"}`;
...
function signedInAuthObject(authenticateContext, sessionToken, sessionClaims) {
  ...
  return {
    ...
    getToken,
    has: (0, import_authorization.createCheckAuthorization)({ orgId, orgRole, orgPermissions, userId, factorVerificationAge }),
...
function computeOrganizationSyncTargetMatchers(options) {
  ...
  if (options?.personalAccountPatterns) {
    try {
      personalAccountMatcher = (0, import_pathToRegexp.match)(options.personalAccountPatterns);
    } catch (e) {
  ...
  if (options?.organizationPatterns) {
    try {
      organizationMatcher = (0, import_pathToRegexp.match)(options.organizationPatterns);
    } catch (e) {
